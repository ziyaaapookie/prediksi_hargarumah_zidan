...
#input the numbers
sqft_liv = st.slider("What is your square feet of living room? ( Luas Ruang Tamu ) ",int(data.sqft_living.min()),int(data.sqft_living.max()),int(data.sqft_living.mean()) )
sqft_abo = st.slider("What is your square feet of living rooms? ( Luas Ruang Tamu )",int(data.sqft_above.min()),int(data.sqft_above.max()),int(data.sqft_above.mean()) )
bath     = st.slider("How many bathrooms? ( Banyaknya Kamar Mandi )",int(data.bathrooms.min()),int(data.bathrooms.max()),int(data.bathrooms.mean()) )
view = st.slider("view?",int(data.view.min()),int(data.view.max()),int(data.view.mean()) )
sqft_bas   = st.slider("sqft_bas? ( Ruang Bawah Tanahnya Berapa Meter Persegi ?)",int(data.sqft_basement.min()),int(data.sqft_basement.max()),int(data.sqft_basement.mean()) )
condition  = st.slider("condition? ( Kondisi )",int(data.condition.min()),int(data.condition.max()),int(data.condition.mean()) )
...
#import your model
# Metode Yang Digunakan regresi linear
